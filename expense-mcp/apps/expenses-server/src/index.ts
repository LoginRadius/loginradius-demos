...
app.listen(PORT, () => {
  ...
  console.log(`      POST ${config.MCP_RESOURCE_URL}`);
  console.log("");
  console.log("   🌐 REST API:");
  console.log(`      ${config.REST_RESOURCE_URL}`);
  console.log("");
  console.log("   🔐 OAuth Metadata:");
  console.log(`      ${localUrl}/.well-known/oauth-protected-resource`);
  console.log(
    `      ${config.REST_RESOURCE_URL}/.well-known/oauth-protected-resource`,
  );
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n");
});
