...
│   └── vue/                 # Vue 3 + Vite
└── loginradius-react/       # React SDK (@loginradius/loginradius-react)
...
| `@loginradius/loginradius-react` | [`@loginradius/loginradius-react`](https://www.npmjs.com/package/@loginradius/loginradius-react) | You're building a React app and want first-class hooks (`useLoginRadiusSDK`, `useLRAuth`) and pre-built components. |
...
### `@loginradius/loginradius-react` (React hooks + components)
