...
A Vite-powered React SPA that mounts the LoginRadius `<Auth>` flow at `/` and a profile view at `/user`, demonstrating end-to-end authentication with `@loginradius/loginradius-react`.
