...
A Next.js App Router demo that renders the LoginRadius `<Login>` component inside a client page, showing how to integrate `@loginradius/loginradius-react-sdk` with React Server Components.
